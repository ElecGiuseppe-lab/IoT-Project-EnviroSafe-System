...
implementation {
	...
	components new Msp430SensorsAdcC() as AnalogSensorsDriver;
	EnviroSafeC.RawPropane -> AnalogSensorsDriver.rawLPG;
	EnviroSafeC.RawCO -> AnalogSensorsDriver.rawCO;
	EnviroSafeC.RawFlame -> AnalogSensorsDriver.rawFlame;
